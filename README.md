...
[![GoDoc](https://godoc.org/github.com/Chain-Zhang/goproxy?status.svg)](https://godoc.org/github.com/Chain-Zhang/goproxy)
[![Join the chat at https://gitter.im/Chain-Zhang/goproxy](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/Chain-Zhang/goproxy?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge)
...
Get the latest goproxy from `gopkg.in/Chain-Zhang/goproxy.v1`.
...
import (
    "github.com/Chain-Zhang/goproxy"
    "log"
    "net/http"
)
...
[the eavesdropper example](https://github.com/Chain-Zhang/goproxy/blob/master/examples/goproxy-eavesdropper/main.go#L27)
2. Transparent proxy support for http/https including MITM certificate generation for TLS.  See the [transparent example.](https://github.com/Chain-Zhang/goproxy/tree/master/examples/goproxy-transparent)
